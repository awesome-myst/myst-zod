...
export const blockBreakSchema = nodeSchema.extend({
  type: z.literal("blockBreak").describe("identifier for node variant"),
  meta: z.string().optional().describe("Block metadata. Conventionally this is a stringified JSON dictionary but it may be any arbitrary string."),
