...
const awardTransform = (
  ...
  if (typeof data.investigators === "string") {
    data.investigators = [data.investigators];
  }

  if (
    Array.isArray(data.investigators) &&
    data.investigators.length > 0 &&
    typeof data.investigators[0] === "object" &&
    data.investigators[0] !== null
  ) {
...
export const awardSchema: ZodType<Award> = z
  .object({
    ...
    recipients: z
      .union([z.array(z.record(z.string(), z.string())), z.array(z.string())])
      .optional()
...
export const fundingSchema: ZodType<Funding> = z
  .union([
    ...
    z.object({
      ...
      awards: z
        .union([awardSchema, z.array(awardSchema)])
        .optional()
